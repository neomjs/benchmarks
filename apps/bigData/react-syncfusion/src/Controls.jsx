...
function Controls({ onDataConfigChange, onFilterChange, filteredRowCount }) {
  ...
  }, [amountRows, amountColumns, theme, selectionModel, rowSelectionType]);
          ...
          <div className="settings-tab-content">
            ...
            <div className="control-group">
              ...
              <div>
                ...
                />
                <label htmlFor="theme-material">Material</label>
              </div>
              <div>
                <input
                  type="radio"
                  ...
                  name="theme"
                  value="bootstrap"
                  checked={theme === 'bootstrap'}
                  onChange={(e) => setTheme(e.target.value)}
                />
                <label htmlFor="theme-bootstrap">Bootstrap</label>
              </div>
              <div>
                <input
                  type="radio"
                  ...
                  name="theme"
                  value="tailwind"
                  checked={theme === 'tailwind'}
                  onChange={(e) => setTheme(e.target.value)}
                />
                <label htmlFor="theme-tailwind">Tailwind</label>
              </div>
            </div>
