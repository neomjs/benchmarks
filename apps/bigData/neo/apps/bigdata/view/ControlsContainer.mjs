import * as selection from '../../../node_modules/neo.mjs/src/selection/grid/_export.mjs';
...
/**
 * @class BigData.view.ControlsContainer
...
class ControlsContainer extends Container {
    ...
    static config = {
        /**
         * @member {String} className='BigData.view.ControlsContainer'
         * @protected
         */
        className: 'BigData.view.ControlsContainer',
        /**
         * @member {String[]} cls=['bigdata-controls-container']
         * @reactive
         */
        cls: ['bigdata-controls-container'],
        /**
         * @member {Object[]} items
         */
        items: [{
