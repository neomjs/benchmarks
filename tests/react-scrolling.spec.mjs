...
const measureScrollingJankInBrowser = () => {
    return new Promise((resolve, reject) => {
        // TanStack Virtual uses a container div for scrolling
...
test('React benchmark: Scrolling Performance Under Duress', async ({page}) => {
    ...
    // For React, we expect the main thread to be heavily impacted by the real-time feed's
    // state updates, leading to significant jank and low FPS during the scroll.
    // This is the expected outcome and the basis for comparison.
